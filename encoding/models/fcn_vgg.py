...
class FCN32s(BaseNet):
    """There are some difference from original fcn"""

    def __init__(self, nclass, backbone='vgg16', aux=False,se_loss=False, pretrained_base=True,
                 norm_layer=nn.BatchNorm2d, **kwargs):
        super(FCN32s, self).__init__(nclass, backbone, aux, se_loss, norm_layer=norm_layer, **kwargs)
        self.aux = aux
#        if backbone == 'vgg16':
...
def get_fcn32s(dataset='pascal_voc', backbone='vgg16', pretrained=False, root='~/.encoding/models',
...
def get_fcn16s(dataset='pascal_voc', backbone='vgg16', pretrained=False, root='~/.encoding/models',
               pretrained_base=True, **kwargs):
    acronyms = {
        'pascal_voc': 'pascal_voc',
        'pascal_aug': 'pascal_aug',
...
def get_fcn8s(dataset='pascal_voc', backbone='vgg16', pretrained=False, root='~/.encoding/models',
              pretrained_base=True, **kwargs):
    acronyms = {
        'pascal_voc': 'pascal_voc',
        'pascal_aug': 'pascal_aug',
